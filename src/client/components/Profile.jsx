        ...
        <>  
            ...
            <div className="mx-auto bg-white shadow-lg rounded-lg flex flex-col items-center py-[50px] w-5/6 md:w-2/3 lg:w-1/2">
                ...
                <div class="flex flex-col gap-[20px]">
                    <Link to="/">
                        <button className='flex font-bold w-[150px] text-sm font-medium rounded-md border-2 border-gray-500' >
                            <span className='font-inter mx-auto text-gray-500'>Log out</span>
                        </button>
                    </Link>
                    <button className='flex font-bold w-[150px] text-sm font-medium rounded-md border-2 border-red-500' >
