	...
	return (
		<>
			...
			<div className="w-100vw h-100vh flex items-center justify-center absolute z-10 left-0 top-0 right-0 bottom-0">
				<div className="flex mx-auto justify-items-stretch flex-col gap-4 w-[420px] h-[250px] bg-white rounded-md dark:bg-[#373D47] dark:text-white p-6">
					<div className="text-[14px] text-gray-500 dark:text-white mb-2">
						{title}
					</div>
					<div className="text-[11px] flex-grow text-[#313131] dark:text-white mb-2">
						{description}
					</div>
					<div className="flex h-12 items-start gap-6 flex-row">
						<span>
							<button
								className={`px-5 py-1 rounded text-[11px] bg-[#313131] text-white dark:bg-gray-900 dark:hover:bg-gray-950`}
						...
						<span>
							<button
								className={`px-5 py-1 rounded text-[11px] border border-[#313131] hover:bg-[#313131] hover:text-white dark:text-white dark:bg-transparent dark:border-gray-900 dark:hover:border-gray-950`}
								onClick={() => setModalOptions({ showModal: false })}
								type="button"
							>
								{prompts[1]}
