...
const RequestAccess = () => {
  ...
  return (
    <>
      <Nav />
      <div
        className={`mx-auto block h-[455px] my-10 shadow-lg rounded-lg flex flex-col items-center p-[50px] lg:w-2/5 ${
          dark ? "bg-[#202530]" : "bg-white"
        }`}
      >
        <h1
          className={`mb-[20px] font-inter text-3xl font-bold text-center ${
        ...
        <div class="flex flex-col gap-[20px]">
          {submitted ? (
            <p
              className={`mx-auto mt-16 font-inter w-5/6 leading-6 text-sm text-center ${
                dark ? "text-[#DDDCDC]" : null
              }`}
            >
            ...
            <>
              <p
                className={`mb-[20px] font-inter text-sm ${
                  dark ? "text-[#DDDCDC]" : null
                }`}
              >
                ...
                <div class="w-[300px] flex flex-col gap-2  mb-4">
                  <label
                    ...
                    className={`font-inter text-sm  ${
                      dark ? "text-[#DDDCDC]" : "text-gray-900"
                    } `}
                  >
                    Name *
                  </label>
