...
export default function Projects() {
	...
	return (
		<div className="h-[75vh] w-full justify-start items-start shadow-lg rounded-lg text-sm flex flex-col md:px-[40px] py-[20px] lg:w-[65%] lg:mx-auto bg-white/90 dark:bg-[#202530] border border-transparent border-1 dark:border-[#373D47] overflow-auto gap-[10px]">
