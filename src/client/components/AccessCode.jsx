...
const AccessCode = () => {
	...
	return (
		<>
			<div className="mx-2 lg:mx-auto block h-[455px] shadow-lg rounded-lg backdrop-blur-lg text-sm flex flex-col items-center p-[40px] lg:w-2/5 bg-white/75 dark:bg-[#202530]/75 border border-transparent border-1 dark:border-[#373D47]">
