...
const AccessCode = () => {
  ...
  return (
    <>
      <Nav />
      <div
        className={`mx-auto block h-[455px] my-10 shadow-lg rounded-lg flex flex-col items-center p-[40px] lg:w-2/5 ${
      ...
      >
        <div className="flex flex-col h-full">
          <div>
            <h1
              className={`font-inter mb-[20px] text-3xl font-bold text-center ${
            ...
            <p
              className={`font-inter font-light text-sm text-center ${
            ...
            <p
              className={`font-inter text-sm font-light mb-[50px] text-center ${
                dark ? "text-white" : null
              }`}
            >
        ...
        <div className={`${dark ? "text-white" : "text-slate-600"} items-end`}>
