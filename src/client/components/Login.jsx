...
const Login = () => {
	...
	return (
		<>
			<div className="mx-2 lg:mx-auto  block h-[455px] my-10 shadow-lg rounded-lg text-sm flex flex-col items-center p-[40px] backdrop-blur-lg lg:w-2/5 bg-white/75 border border-1 border-transparent dark:bg-[#202530]/75 dark:border-[#373D47]">
