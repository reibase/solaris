...
export default function Projects() {
	...
	return (
		...
		<div className="w-full h-full flex flex-col gap-[10px]">
			...
			<div className="w-full h-60 items-start justify-start p-4 shadow-md rounded-lg text-sm flex flex-col bg-white/90 dark:bg-[#202530] border border-transparent border-1 dark:border-[#373D47]">
				...
				<div className="flex flex-row w-full justify-between">
					...
					<div className="flex flex-row gap-[20px]">
						<span className="font-semibold dark:text-white">{data?.title}</span>
					...
					{/* top right of header */}
					<span className="text-[12px] font-semibold dark:text-[#DDDCDC] whitespace-nowrap">
						50000 Credits
					</span>
				</div>
			...
			<div className="w-full pl-2 shadow-lg rounded-lg text-sm flex flex-col items-center bg-white/90 dark:bg-[#202530] border border-transparent border-1 dark:border-[#373D47] justify-between overflow-auto">
				<div className="w-full h-full overflow-auto pr-4">
					{data &&
						data?.Issues.map((pullRequest, index) => (
							<div className="flex flex-row w-full justify-between border-b border-[#D4D4D4] p-3 pr-1 mt-2 mb-1 hover:bg-slate-100/25 dark:hover:bg-[#161f2d] dark:border-[#373D47]">
